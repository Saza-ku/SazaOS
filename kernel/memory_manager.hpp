...
class BitmapMemoryManager {
 public:
   ...
   * この呼び出し以降、Allocate によるメモリ割当は設定された範囲内でのみ行われる。
   * 
